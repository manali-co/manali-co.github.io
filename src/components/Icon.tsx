/* Lucide glyphs (ISC), inlined: the brand defines no icon set, so these stay few and quiet. */
const PATHS: Record<string, string> = {
  ...
  bot: "M12 8V4H8M20 14v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4M2 14h2M20 14h2M15 13v2M9 13v2M4 8h16a2 2 0 0 1 2 2v4H2v-4a2 2 0 0 1 2-2z",
  ...
  scholar: "M21.42 10.92 12.71 15.6a1.5 1.5 0 0 1-1.42 0L2.58 10.92a1 1 0 0 1 0-1.84l8.71-4.68a1.5 1.5 0 0 1 1.42 0l8.71 4.68a1 1 0 0 1 0 1.84zM22 10v6M6 12.5V16a6 3 0 0 0 12 0v-3.5",
  message: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",
  x: "M4 4l16 16M20 4L4 20",
  butterfly: "M12 10.5c-1.8-3.4-5.2-6.5-8-6.5C2.4 4 2 5.2 2 6.6c0 3.2 1.4 7.4 5.6 7.4-3 0-4.4 1.6-3.6 3.6.8 1.8 3.4 2.4 5.2.6 1.2-1.2 2.2-3.3 2.8-4.9.6 1.6 1.6 3.7 2.8 4.9 1.8 1.8 4.4 1.2 5.2-.6.8-2-.6-3.6-3.6-3.6 4.2 0 5.6-4.2 5.6-7.4C22 5.2 21.6 4 20 4c-2.8 0-6.2 3.1-8 6.5z",
