    ...
    <footer className="footer">
      <div className="wrap footer__inner">
        ...
        <div className="footer__coffee">
          <p>Built with love, mostly at night.{site.coffee ? " If something here made your evening better, buy us a coffee. Any amount, no pressure." : ""}</p>
          {site.coffee && <a className="button button--sm" href={site.coffee}><Icon name="coffee" size={15} /> Buy us a coffee</a>}
        </div>
